...
const mockLoadDemoData = api.loadDemoData as jest.MockedFunction<typeof api.loadDemoData>;
...
describe('DemoSection', () => {
    ...
    it('renders the demo section with load button', () => {
        ...
        expect(screen.getByRole('button', { name: /load example session/i })).toBeInTheDocument();
    });
    ...
    it('loads demo data when button is clicked', async () => {
        ...
        const loadButton = screen.getByRole('button', { name: /load example session/i });
    ...
    it('allows toggling between formatted and raw markdown', async () => {
        ...
        await waitFor(() => {
            ...
            expect(screen.getByRole('button', { name: /raw markdown/i })).toBeInTheDocument();
        });
