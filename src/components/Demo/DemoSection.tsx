  ...
  const handleEntityMerge = (
    ...
    setEntities((prev) => {
      const filtered = prev.filter(
        (entity) => !duplicateIds.includes(entity.id)
      );
      const primaryIndex = filtered.findIndex(
        (entity) => entity.id === primaryEntity.id
      );
      if (primaryIndex >= 0) {
  ...
  return (
    <div className='space-y-6'>
        ...
        <div className='flex items-start justify-between'>
          <div className='flex-1'>
            ...
            <p className='text-gray-600 mb-4'>
              Load an example session note from a Dungeons & Dragons campaign to
              see how the parser extracts NPCs, locations, items, and other
            ...
            <div className='bg-white/70 rounded-lg p-4 mb-4'>
              ...
              <p className='text-sm text-gray-600'>
                This session note describes adventurers gathering at the Yawning
                Portal tavern, meeting various NPCs, and receiving their first
                quest. The parser will identify characters like Durnan,
                Volothamp Geddarm, and locations like Waterdeep.
              </p>
            </div>
          </div>
        </div>
      ...
      {demoData && (
        <div className='space-y-6'>
          {/* Document Content */}
          <DocumentViewer parsedData={demoData} />
          ...
          <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6'>
            <div className='mb-4'>
              ...
              <p className='text-gray-600 text-sm'>
                The parser automatically identified {entities.length} entities
                from the session notes. You can view, edit, merge duplicates,
                and export them to Obsidian format.
              </p>
            </div>
